...
#if !defined( _LIBLUKSDE_LIBCTHREADS_H )
#define _LIBLUKSDE_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBLUKSDE )
#define HAVE_LIBLUKSDE_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBLUKSDE_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBLUKSDE_LIBCTHREADS_H ) */
