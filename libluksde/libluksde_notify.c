...
{
	static char *function = "libluksde_notify_set_stream";
...
int libluksde_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libluksde_notify_stream_open";
...
int libluksde_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libluksde_notify_stream_close";
