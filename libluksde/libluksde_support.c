...
#include "libluksde_libclocale.h"
#include "libluksde_support.h"
...
const char *libluksde_get_version(
             void )
{
	return( (const char *) LIBLUKSDE_VERSION_STRING );
}
...
int libluksde_get_access_flags_read(
     void )
{
	return( (int) LIBLUKSDE_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libluksde_get_codepage";
...
int libluksde_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libluksde_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libluksde_check_volume_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libluksde_check_volume_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libluksde_check_volume_signature_file_io_handle";
