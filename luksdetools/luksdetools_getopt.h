...
#if !defined( _LUKSDETOOLS_GETOPT_H )
#define _LUKSDETOOLS_GETOPT_H
...
typedef struct luksdetools_option luksdetools_option_t;

struct luksdetools_option
{
...
#define luksdetools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t luksdetools_getopt(
                  int argument_count,
...
void luksdetools_getopt_wrapped_fprint(
      FILE *stream,
...
void luksdetools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const luksdetools_option_t *options,
      int number_of_options );

int luksdetools_getopt_get_options_string(
     const luksdetools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _LUKSDETOOLS_GETOPT_H ) */
