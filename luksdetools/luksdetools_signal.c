...
void (*luksdetools_signal_signal_handler)( luksdetools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( luksdetools_signal_signal_handler != NULL )
			{
				luksdetools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "luksdetools_signal_attach";
...
#if defined( _MSC_VER )
	luksdetools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	luksdetools_signal_signal_handler = NULL;
