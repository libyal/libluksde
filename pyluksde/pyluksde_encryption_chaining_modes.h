...
#if !defined( _PYLUKSDE_ENCRYPTION_CHAINING_MODES_H )
#define _PYLUKSDE_ENCRYPTION_CHAINING_MODES_H
...
typedef struct pyluksde_encryption_chaining_modes pyluksde_encryption_chaining_modes_t;
...
extern PyTypeObject pyluksde_encryption_chaining_modes_type_object;
