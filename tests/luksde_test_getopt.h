...
#if !defined( _LUKSDE_TEST_GETOPT_H )
#define _LUKSDE_TEST_GETOPT_H
...
#define luksde_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t luksde_test_getopt(
                  int argument_count,
...
#endif /* !defined( _LUKSDE_TEST_GETOPT_H ) */
