...
LIBRARY_TESTS="encryption_context error io_handle key_slot notify password sector_data sector_data_vector volume_header";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./luksde_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libluksde");
