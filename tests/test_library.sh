...
LIBRARY_TESTS="error key_slot notify sector_data";
...
run_test_with_input()
{
	...
	run_test_on_input_directory "libluksde" "${TEST_DESCRIPTION}" "default" "${OPTION_SETS}" "${TEST_EXECUTABLE}" "input" "${INPUT_GLOB}";
	local RESULT=$?;
