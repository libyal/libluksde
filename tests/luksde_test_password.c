     ...
     void )
{
	...
	luksde_test_password_pbkdf2_test_vector_t test_vectors[ 24 ] = {
		/* RFC 3962 test vectors
		 */
		{ LIBLUKSDE_HASHING_METHOD_SHA1, 1, "password", 8,
		...
		{ LIBLUKSDE_HASHING_METHOD_SHA1, 1200, "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", 64,
		...
		{ LIBLUKSDE_HASHING_METHOD_SHA1, 1200, "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", 65,
		...
		{ LIBLUKSDE_HASHING_METHOD_SHA1, 50, "\xf0\x9d\x84\x9e", 4,
		...
		{ LIBLUKSDE_HASHING_METHOD_SHA1, 4096, "pass\0word", 9,
		  { 's', 'a', 0, 'l', 't' }, 5,
