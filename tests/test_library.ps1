...
$LibraryTests = "error key_slot notify sector_data volume_header"
...
Function RunTest
{
	...
	$TestExecutable = "${TestToolDirectory}\luksde_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libluksde"
